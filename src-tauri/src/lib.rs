...
use adapters::{
    ...
    complete_testing_set, continue_install, first_run_step, last_used_repo, list_inbox,
    open_app_install, remove_testing_set_repo, save_capture, setup_tray, show_capture,
    show_capture_window, sign_in_with_github, sign_in_with_pat, sign_out, testing_set,
    AppState,
};
use std::sync::Mutex;
use tauri::Manager;
